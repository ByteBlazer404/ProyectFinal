    ...
    <div class="navbar navbar-inverse navbar-fixed-top" data-spy="affix" data-offset-top="100">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="inicio.php"><img class="img-responsive logo img-thumbnail" src="../img/Logo.jpeg" alt="" width="100px" height="100px"></a>
        </div>
        <div id="navbar" class="collapse navbar-collapse">
          ...
          if($_SESSION['usuario']!=="admin"):
           ...
           <li class="active"><a href="Compras.php"><span class="glyphicon glyphicon-home"></span> Comprar</a>
            </li>
